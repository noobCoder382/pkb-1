...
function $showResults(appState){
	if(appState.correctAnswers === 10){
		...
		if(appState.progress.incorrectCategories.length === 0){
			endFeedback = `Badhaiyan Badhaiyan Badhaiyan! Janamdin ki gaadha gaadha badhaai!!!!!!!!!!!!!, we don't have something for you here! "<a href = "https://priyanshisharma.me" >kya hai???????</a>"`;
		} else {
